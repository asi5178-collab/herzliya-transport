...
const run = db.transaction(() => {
  ...
  // Weekly RUP data (weeks 18-22, from real documents)
  const rupRows = [
  ...
  // Weekly analysis (real data from Claude analysis in documents)
  const analyses = [
    ...
    { week: '2026-05-19', num: 21, nps: 2.93, level: 'critical',
      ...
      tasks: JSON.stringify([{title:'מעבר דחוף לאוטובוס גדול',priority:'high',deadline:'2026-05-25'},{title:'בדיקת פערי נתוני נסיעה',priority:'high',deadline:'2026-05-22'},{title:'פתרון לתלמידי סמיר (Skipper 6)',priority:'high',deadline:'2026-05-25'}]),
  ...
  console.log('[OK] Sample data added successfully');
});
